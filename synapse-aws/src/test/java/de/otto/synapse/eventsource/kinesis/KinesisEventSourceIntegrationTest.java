package de.otto.synapse.eventsource.kinesis;
...
import de.otto.synapse.endpoint.receiver.kinesis.KinesisMessageLogReceiverEndpoint;
import de.otto.synapse.endpoint.receiver.kinesis.KinesisShardIterator;
...
public class KinesisEventSourceIntegrationTest {
    ...
    public void before() {
         ...
         */
        final KinesisMessageLogReceiverEndpoint kinesisMessageLog = new KinesisMessageLogReceiverEndpoint(TEST_CHANNEL, messageInterceptorRegistry, kinesisClient, objectMapper, null);
