...
public class ChronicleMapStateRepository<V> implements StateRepository<V> {
    ...
    public ChronicleMapStateRepository(final ChronicleMapBuilder<String, V> chronicleMapBuilder,
                                       final long expectedNumberOfEntries) {
        this.expectedNumberOfEntries = expectedNumberOfEntries;
        store = chronicleMapBuilder.create();
    }
    ...
    private double offHeapMemoryInGB() {
        return (double)store.offHeapMemoryUsed() / 1024 / 1024 / 1024;
    }
