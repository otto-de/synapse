...
import de.otto.synapse.endpoint.receiver.kinesis.AsyncKinesisMessageLogReceiverEndpoint;
...
import static de.otto.synapse.acceptance.AsyncKinesisMessageLogReceiverEndpointIntegrationTest.IntegratedTestConfiguration.AWS_KINESIS_CHANNEL;
...
@SpringBootTest(classes = AsyncKinesisMessageLogReceiverEndpointIntegrationTest.class, properties = "synapse.aws.profile=${AWS_PROFILE}")
@EnableMessageSenderEndpoint(name = "kinesisSender", channelName = AWS_KINESIS_CHANNEL, selector = Kinesis.class)
@DirtiesContext
public class AsyncKinesisMessageLogReceiverEndpointIntegrationTest {
    ...
    private static final Logger LOG = getLogger(AsyncKinesisMessageLogReceiverEndpointIntegrationTest.class);
    ...
    public void before() {
         ...
         */
        kinesisMessageLog1 = new AsyncKinesisMessageLogReceiverEndpoint(AWS_KINESIS_CHANNEL, interceptorRegistry, kinesisAsyncClient, new ObjectMapper(), null);
        ...
        kinesisMessageLog2 = new AsyncKinesisMessageLogReceiverEndpoint(AWS_KINESIS_CHANNEL, interceptorRegistry, kinesisAsyncClient, new ObjectMapper(), null);
